  ...
  return (
    <main className="team-management-container">
      <div className="team-management-header">
        ...
        <p className="header-subtitle">管理所有空间和团队</p>
      </div>

      <Card variant="borderless" className="team-content-card">
        <div className="team-filter-bar">
          <Space wrap>
            ...
            <Button icon={<ReloadOutlined />} onClick={() => { setSearchName(''); setSearchType(undefined); setCurrent(1); fetchData(1, pageSize); }}>重置</Button>
          </Space>
        </div>
